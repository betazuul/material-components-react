...
class MDCExpansionPanelAccordionFoundation extends MDCFoundation {
  ...
  constructor(adapter) {
    super(
      Object.assign(
        MDCExpansionPanelAccordionFoundation.defaultAdapter,
        adapter
      )
    );
  ...
  init() {
    this.adapter_.registerChildrenExpansionPanelInteractionListener(
      MDCExpansionPanelFoundation.strings.EXPAND_EVENT,
      this.expansionHandler_
    );
  }

  destroy() {
    this.adapter_.deregisterChildrenExpansionPanelInteractionListener(
      MDCExpansionPanelFoundation.strings.EXPAND_EVENT,
      this.expansionHandler_
    );
  }
