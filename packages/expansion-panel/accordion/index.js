...
class MDCExpansionPanelAccordion extends MDCComponent {
  ...
  initialize() {
    this.childrenExpansionPanels_ = util
      .toArray(this.root_.querySelectorAll(strings.CHILD_SELECTOR))
      .filter(e => !e.classList.contains(cssClasses.EXCLUDED));
  }
